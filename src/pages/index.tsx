  ...
  return (
    <>
      ...
      <div className='flex flex-col'>
       <button className="border-2 border-slate-50 h-60 w-60 bg-green-600 text-white text-9xl" onClick={Tictac}>O</button>
       <button className="border-2 border-slate-50 h-60 w-60 bg-red-600 text-white text-9xl" onClick={Tictac}>X</button>
